...
export default function Home() {
    ...
    return (
        <>
            {/* Hero Section */}
            <TopNav />
            <Box color="black" p={10} textAlign="left" mt="20">
                ...
                >
                    ...
                    </Heading>      <Text fontFamily="body" fontSize="x" color="black" mb={6} width="40%">
                ...
                >
                    ...
                    <Box width="45%">
                        <Image
                            ...
                            alt="IPad Nurse"
                            width="100%"       // Set to 100% for responsiveness within the container
                            height="auto"       // Auto height to keep the image aspect ratio
                            objectFit="cover"   // Cover to maintain proportions without distortion
                            zIndex={2}
