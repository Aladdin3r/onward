...
export default function Home() {
    ...
    return (
        <>
            ...
            <Box p={40} textAlign="center" borderRadius="md" boxShadow="lg" maxW="90%" mx="auto" mt={-20}>
                <Heading fontFamily="heading" fontSize="5xl" mb={20} mt="">What We Offer</Heading>
                <Flex justify="center" gap={20} mb={30}>
                    <Stack width="300px" height="300px" borderRadius="md" boxShadow="md" p={6} textAlign="center" alignItems="center">
