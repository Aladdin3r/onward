  ...
  export default function Home() {
    ...
    return (
      <>
        {/* Hero Section */}
        <TopNav/>
        <Box  color="black" p={10} textAlign="center">
          <Heading fontFamily="heading" fontSize="6xl" fontWeight="bold" widthmb={4}>
            ...
            <Text as="span">POTENTIAL TODAY.</Text>            <Text as="span">POTENTIAL TODAY.</Text>
