  ...
  export default function Home() {
    ...
    return (
      <Layout>
        ...
        {/* FAQ Section */}
        <Box bg="gray.100" p={10} borderRadius="md" boxShadow="lg" maxW="800px" mx="auto">
          <Heading fontFamily="heading" fontSize="3xl" textAlign="center" mb={4}>FAQs</Heading>
          <Text fontFamily="body" fontSize="lg" textAlign="center" mb={8}>
          ...
          <Accordion allowToggle>
            ...
            <AccordionItem>
              <h2>
                <AccordionButton>
                  <Box as="span" flex="1" textAlign="left" boxShadow="md" fontFamily="heading">Why did we make this site?</Box>
                  <AccordionIcon />
                </AccordionButton>
              </h2>
              <AccordionPanel pb={4} fontFamily="body">
