      ...
      <Box p={10} textAlign="center">
        ...
        <Flex justify="center" gap={6}>
          ...
          <Stack width="300px" borderRadius="md" boxShadow="md" p={6} textAlign="center">
            ...
            <div className="FeatureListCard" style={{width: 451, height: 504, paddingLeft: 28, paddingRight: 28, paddingTop: 72, paddingBottom: 72, background: 'white', boxShadow: '0px 0px 18.5px -4px rgba(50.55, 81.85, 207.03, 0.65)', borderRadius: 25, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 28, display: 'inline-flex'}}>
  <div className="MdiCubeOutline" style={{width: 42, height: 42, position: 'relative'}}>
    <div className="Vector" style={{width: 31.50, height: 35, left: 5.25, top: 3.50, position: 'absolute', background: 'black'}}></div>
  </div>
  <div className="Feature" style={{width: 394, textAlign: 'center', color: 'black', fontSize: 40, fontFamily: 'DM Sans', fontWeight: '600', lineHeight: 49.20, wordWrap: 'break-word'}}>Personalized Coaching for Your Success</div>
  <div className="Description" style={{width: 310, textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'DM Sans', fontWeight: '400', lineHeight: 30, wordWrap: 'break-word'}}>Receive AI coaching sessions tailored to your unique needs. </div>
</div>
          </Stack>
        </Flex>
      </Box>
